...
@section('left_panel_content')
    <h2 class="text-3xl md:text-4xl font-black mb-4 tracking-tight text-white">Admin Workspace</h2>
    ...
    <div class="space-y-3">
        <div class="flex items-center space-x-4 bg-white/5 p-4 rounded-xl border border-white/5 backdrop-blur-md">
            <div class="w-10 h-10 bg-purple-500/20 rounded-lg flex items-center justify-center text-purple-400 shrink-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            </div>
            <div>
                <h4 class="font-bold text-white text-base">User Management</h4>
                <p class="text-sm text-gray-400 font-medium">Control access and permissions for all users.</p>
            </div>
        </div>
        <div class="flex items-center space-x-4 bg-white/5 p-4 rounded-xl border border-white/5 backdrop-blur-md">
            <div class="w-10 h-10 bg-fuchsia-500/20 rounded-lg flex items-center justify-center text-fuchsia-400 shrink-0">
            ...
            <div>
                <h4 class="font-bold text-white text-base">System Health</h4>
                <p class="text-sm text-gray-400 font-medium">Monitor API integrations and platform status.</p>
            </div>
        </div>
    </div>
@endsection
