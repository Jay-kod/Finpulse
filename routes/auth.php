...
// --- ANALYST GUEST ROUTES ---
Route::middleware('guest:analyst')->group(function () {
    Route::get('analyst/register', [RegisteredUserController::class, 'createAnalyst'])->name('analyst.register');
    Route::post('analyst/register', [RegisteredUserController::class, 'storeAnalyst'])->name('analyst.register.store');

    Route::get('analyst/login', [AuthenticatedSessionController::class, 'createAnalyst'])->name('analyst.login');
    Route::post('analyst/login', [AuthenticatedSessionController::class, 'storeAnalyst']);
});
...
// --- WEB / VIEWER AUTHENTICATED ROUTES ---
...
// --- ANALYST AUTHENTICATED ROUTES ---
Route::middleware('auth:analyst')->group(function () {
    Route::post('analyst/logout', [AuthenticatedSessionController::class, 'destroyAnalyst'])->name('analyst.logout');
});
